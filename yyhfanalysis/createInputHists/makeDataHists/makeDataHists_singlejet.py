...
def makehistograms(inputFile):
	...
	for i in range(nEntries):
		...
		if (nLeptons == 0):
			if (isyj2):
				histyj_lp2.Fill(LeadJet_btagbin);#print("filling histyj_lp2")
			elif (isjj2):
				histjj_lp2.Fill(LeadJet_btagbin);#print("filling histjj_lp2")
			elif (isyj3):
				histyj_lp3.Fill(LeadJet_btagbin);#print("filling histyj_lp3")
			elif (isjj3):
				histjj_lp3.Fill(LeadJet_btagbin);#print("filling histjj_lp3")
			elif (isyj5):
				histyj_lp5.Fill(LeadJet_btagbin);#print("filling histyj_lp5")
			elif (isjj5):
				histjj_lp5.Fill(LeadJet_btagbin);#print("filling histjj_lp5")
		if (nLeptons == 0): 
			if (isyj2):
				histyj_lp2_noMET.Fill(LeadJet_btagbin);#print("filling histyj_lp2")
			elif (isjj2):
				histjj_lp2_noMET.Fill(LeadJet_btagbin);#print("filling histjj_lp2")
			elif (isyj3):
				histyj_lp3_noMET.Fill(LeadJet_btagbin);#print("filling histyj_lp3")
			elif (isjj3):
				histjj_lp3_noMET.Fill(LeadJet_btagbin);#print("filling histjj_lp3")
			elif (isyj5):
				histyj_lp5_noMET.Fill(LeadJet_btagbin);#print("filling histyj_lp5")
			elif (isjj5):
				histjj_lp5_noMET.Fill(LeadJet_btagbin);#print("filling histjj_lp5")
...
newFile_lp2 = ROOT.TFile("data_lp2_singlejet.root", "recreate")
newFile_lp3 = ROOT.TFile("data_lp3_singlejet.root", "recreate")
newFile_lp5 = ROOT.TFile("data_lp5_singlejet.root", "recreate")

newFile_lp2.cd()
histyj_lp2 = ROOT.TH1F("histyj_lp2","histyj_lp2",5,-0.5,4.5)
histjj_lp2 = ROOT.TH1F("histjj_lp2","histjj_lp2",5,-0.5,4.5)
histyj_lp2_noMET = ROOT.TH1F("histyj_lp2_noMET","histyj_lp2_noMET",5,-0.5,4.5)
histjj_lp2_noMET = ROOT.TH1F("histjj_lp2_noMET","histjj_lp2_noMET",5,-0.5,4.5)

newFile_lp3.cd()
histyj_lp3 = ROOT.TH1F("histyj_lp3","histyj_lp3",5,-0.5,4.5)
histjj_lp3 = ROOT.TH1F("histjj_lp3","histjj_lp3",5,-0.5,4.5)
histyj_lp3_noMET = ROOT.TH1F("histyj_lp3_noMET","histyj_lp3_noMET",5,-0.5,4.5)
histjj_lp3_noMET = ROOT.TH1F("histjj_lp3_noMET","histjj_lp3_noMET",5,-0.5,4.5)

newFile_lp5.cd()
histyj_lp5 = ROOT.TH1F("histyj_lp5","histyj_lp5",5,-0.5,4.5)
histjj_lp5 = ROOT.TH1F("histjj_lp5","histjj_lp5",5,-0.5,4.5)
histyj_lp5_noMET = ROOT.TH1F("histyj_lp5_noMET","histyj_lp5_noMET",5,-0.5,4.5)
histjj_lp5_noMET = ROOT.TH1F("histjj_lp5_noMET","histjj_lp5_noMET",5,-0.5,4.5)
