...
int main( int argc, char* argv[] ) {
   ...
   if(filetype == "mc") {SH::ScanDir().filePattern("mc16*roo*").scan (sh, inputFile);}
   ...
   if(filetype == "mc") {alg1->SetIsData(false); alg1->SetIsMC(true);}
   // // std::cerr << "BRI TEST isAOD 4 is equal to " << value << std::endl;
   // // else {alg1->SetIsAOD(false);}

   if(filetype == "data"){alg1->SetIsData(true); alg1->SetIsMC(false);}
