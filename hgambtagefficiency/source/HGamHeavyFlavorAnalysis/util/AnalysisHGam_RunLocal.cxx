...
int main( int argc, char* argv[] ) {
   ...
   if(file_type == "PowhegPy8_NNLOPS_ggH125"){SH::ScanDir().filePattern("PowhegPy8_NNLOPS_ggH125").scan (sh, inputFile);}
   ...
   if(file_type == "Sherpa2_diphoton_myy_90_175"){SH::ScanDir().filePattern("mc16a.Sherpa2_diphoton_myy_90_175.MxAODDetailed*").scan (sh, inputFile);}
   if(file_type == "Sherpa2_diphoton_myy_90_175"){SH::ScanDir().filePattern("mc16d.Sherpa2_diphoton_myy_90_175.MxAODDetailed*").scan (sh, inputFile);}
   if(file_type == "Sherpa2_diphoton_myy_90_175"){SH::ScanDir().filePattern("mc16e.Sherpa2_diphoton_myy_90_175.MxAODDetailed*").scan (sh, inputFile);}
